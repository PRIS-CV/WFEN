...
def psnr_ssim_dir(gt_dir, test_dir):
    ...
    return '%.3f'%(psnr_score / len(gt_img_list)), '%.5f'%(ssim_score / len(gt_img_list))

if __name__ == '__main__':

    # gt_dir = '/home/liwenjie/wenjieli/Face_SR/datasets/test_datasets/Helen50/HR/'
    gt_dir = '/home/liwenjie/wenjieli/Face_SR/datasets/test_datasets/CelebA1000/HR/'
    test_dirs = [
            './results_celeba/wfen',
            # './results_helen/wfen',
            ]
